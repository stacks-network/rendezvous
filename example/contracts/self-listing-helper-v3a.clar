...
(define-read-only (get-lock-period)
	(contract-call? 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.liquidity-locker get-lock-period))

(define-read-only (get-locked-liquidity-or-default (owner principal) (pool-id uint))
	(contract-call? 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.liquidity-locker get-locked-liquidity-or-default owner pool-id))

(define-read-only (get-locked-liquidity-for-pool-or-default (pool-id uint))
  (contract-call? 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.liquidity-locker get-locked-liquidity-for-pool-or-default pool-id))

(define-read-only (get-burnt-liquidity-or-default (pool-id uint))
	(contract-call? 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.liquidity-locker get-burnt-liquidity-or-default pool-id))
...
(define-read-only (verify-deploy
	...
	(contract-call? 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.clarity-stacks was-tx-mined-compact
		(try! (calculate-txid (get nonce verify-params) (get fee-rate verify-params) (get signature verify-params) (get contract verify-params) (contract-call? 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.clarity-stacks-helper string-ascii-to-buffer (get-wrapped-token-contract-code (get token-y verify-params)))))
...
(define-public (lock-liquidity (amount uint) (pool-id uint))
	(contract-call? 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.liquidity-locker lock-liquidity amount pool-id))

(define-public (burn-liquidity (amount uint) (pool-id uint))
	(contract-call? 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.liquidity-locker burn-liquidity amount pool-id))

(define-public (claim-liquidity (pool-id uint))
	(contract-call? 'SP1E0XBN9T4B10E9QMR7XMFJPMA19D77WY3KP2QKC.liquidity-locker claim-liquidity pool-id))
