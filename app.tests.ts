  ...
  it.each([
    ...
    [
      ...
      [
        ...
        `Using manifest path: ${manifestDirPlaceholder}/Clarinet.toml`,
        `Target contract: counter`,
        `Mode: NEW (run a fresh round of tests)`,
        `-------------------------------------------------------------------------------`,
        `Starting fresh round of property testing for the counter contract...\n`,
      ],
    ],
    [
    ...
    [
      ...
      [
        ...
        `Mode: NEW (run a fresh round of tests)`,
        `-------------------------------------------------------------------------------`,
        `Starting fresh round of property testing for the reverse contract...\n`,
      ],
    ],
    [
      ...
      [
        ...
        `Mode: NEW (run a fresh round of tests)`,
        `-------------------------------------------------------------------------------`,
        `Starting fresh round of property testing for the slice contract...\n`,
      ],
    ],
    [
      [
